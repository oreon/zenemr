...
<Route path="/admin/GroupEdit" component={GroupEdit}>
 ...
 <Route path="/admin/ProductView/:id" component={ProductView} />
...
<Route path="/admin/ProductEdit" component={ProductEdit}>
 ...
 <Route path="/admin/CategoryView/:id" component={CategoryView} />
...
<Route path="/admin/CustomerEdit" component={CustomerEdit}>
 ...
 <Route path="/admin/CustomerOrderView/:id" component={CustomerOrderView} />
...
<Route path="/admin/CustomerOrderEdit" component={CustomerOrderEdit}>
 ...
 <Route path="/admin/OrderItemView/:id" component={OrderItemView} />
...
<Route path="/admin/EmployeeEdit" component={EmployeeEdit}>
 ...
 <Route path="/admin/CustomerReviewView/:id" component={CustomerReviewView} />
