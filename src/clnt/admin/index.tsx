 ...
 <Route path="/admin/AppUserView/:id" component={CustomerView} />
...
<Route path="/admin/AppUserEdit" component={AppUserEdit}>
 ...
 <Route path="/admin/AppRoleView/:id" component={CustomerView} />
...
<Route path="/admin/AppRoleEdit" component={AppRoleEdit}>
 ...
 <Route path="/admin/GroupView/:id" component={CustomerView} />
...
<Route path="/admin/GroupEdit" component={GroupEdit}>
 ...
 <Route path="/admin/ProductView/:id" component={CustomerView} />
...
<Route path="/admin/ProductEdit" component={ProductEdit}>
 ...
 <Route path="/admin/CategoryView/:id" component={CustomerView} />
...
<Route path="/admin/CategoryEdit" component={CategoryEdit}>
 ...
 <Route path="/admin/CustomerView/:id" component={CustomerView} />
...
<Route path="/admin/CustomerEdit" component={CustomerEdit}>
 ...
 <Route path="/admin/CustomerOrderView/:id" component={CustomerView} />
...
<Route path="/admin/CustomerOrderEdit" component={CustomerOrderEdit}>
 ...
 <Route path="/admin/OrderItemView/:id" component={CustomerView} />
...
<Route path="/admin/OrderItemEdit" component={OrderItemEdit}>
 ...
 <Route path="/admin/EmployeeView/:id" component={CustomerView} />
...
<Route path="/admin/EmployeeEdit" component={EmployeeEdit}>
 ...
 <Route path="/admin/CustomerReviewView/:id" component={CustomerView} />
