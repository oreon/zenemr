 ...
 render() {
    ...
    return (
      ...
      <div>
        ...
        <SimpleList headers= {categoryHeaders} editLink={'Category'}
...
export class CategoryView extends EditViewBase {
  ...
  render() {
    ...
    return (
     <Layout>
       <SimpleView  headers= {categoryHeaders} renderExtra={this.renderExtra}
       record={record}/> 
...
export class CategoryEdit extends EditViewBase {
