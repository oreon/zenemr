 ...
 render() {
    ...
    return (
      ...
      <div>
        ...
        <SimpleList headers= {customerReviewHeaders} editLink={'CustomerReview'}
...
export class CustomerReviewView extends EditViewBase {
  ...
  constructor(props) {
    ...
    this.entityName = 'customerReviews';
  ...
  render() {
    ...
    return (
     <Layout>
       <SimpleView  headers= {customerReviewHeaders} renderExtra={this.renderExtra}
       record={record}/> 
...
export class CustomerReviewEdit extends EditViewBase {
